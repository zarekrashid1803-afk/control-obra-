  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 relative">
      <form className="w-full max-w-md" onSubmit={onSubmit}>
        ...
        <Field label="Nombre de la constructora *">
          <input value={form.nombreConstructora} onChange={(e) => set('nombreConstructora', e.target.value)} required className="input" placeholder="Constructora Ejemplo S.A.S." />
        </Field>
        ...
        <div className="mt-6 px-4 py-3 bg-gray-50 rounded text-[12px] leading-relaxed text-gray-600">
          ...
          acceso completo. Después del periodo tus datos quedan guardados — solo se
          bloquean nuevas operaciones hasta extender el acceso.
        </div>
      </form>
